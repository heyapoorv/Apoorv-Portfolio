...
import heroOverlayImg from '../assets/hero.png';
  ...
  return (
    <section ref={containerRef} className="relative h-[400vh] w-full bg-black">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[10] px-6 md:px-12 lg:px-20 pb-12 pointer-events-auto">
          <div className="w-full max-w-7xl mx-auto flex flex-col justify-end h-full gap-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-8 md:gap-12">
              ...
              <div className="flex flex-col w-full md:w-1/2 lg:w-[45%]">
                <div className="w-10 h-[2px] bg-[#ff2a2a] mb-6"></div>
                <h3 className="hero-title opacity-0 text-[#ff2a2a] text-xs md:text-sm uppercase tracking-widest font-bold mb-4 leading-relaxed break-words">
                  {profile.tagline}
                </h3>
                <p className="hero-subtitle opacity-0 text-white/90 text-sm md:text-base leading-relaxed font-light break-words">
                  {profile.subtitle}
                </p>
              </div>

              {/* Right Column: CTA Links */}
              <div className="flex flex-wrap gap-x-8 gap-y-4 w-full md:w-auto md:justify-end">
                {profile.resumeLink && profile.resumeLink !== '#' && (
                  <a href={profile.resumeLink} target="_blank" rel="noopener noreferrer" className="hero-cta opacity-0 group inline-flex flex-col items-start md:items-end">
                    <div className="flex items-center text-[#ff2a2a] text-[10px] md:text-xs uppercase tracking-widest mb-2 transition-colors duration-300 group-hover:text-white">
                      <span className="mr-2">RESUME</span>
                      <span className="transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">↗</span>
                    </div>
                    <div className="w-full h-[1px] bg-[#ff2a2a]/30 transition-all duration-300 group-hover:bg-white"></div>
                  </a>
                )}
                {profile.github && profile.github !== '#' && (
                  <a href={profile.github} target="_blank" rel="noopener noreferrer" className="hero-cta opacity-0 group inline-flex flex-col items-start md:items-end">
                    <div className="flex items-center text-[#ff2a2a] text-[10px] md:text-xs uppercase tracking-widest mb-2 transition-colors duration-300 group-hover:text-white">
                ...
                {profile.linkedin && profile.linkedin !== '#' && (
                  <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="hero-cta opacity-0 group inline-flex flex-col items-start md:items-end">
                    <div className="flex items-center text-[#ff2a2a] text-[10px] md:text-xs uppercase tracking-widest mb-2 transition-colors duration-300 group-hover:text-white">
                ...
                <a href="#contactme" className="hero-cta opacity-0 group inline-flex flex-col items-start md:items-end">
                  <div className="flex items-center text-[#ff2a2a] text-[10px] md:text-xs uppercase tracking-widest mb-2 transition-colors duration-300 group-hover:text-white">
            ...
            {/* Bottom Row */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center pt-8 border-t border-white/10 gap-6 md:gap-0">
              ...
              <div className="text-white/40 text-[9px] md:text-[10px] uppercase tracking-widest font-mono">
